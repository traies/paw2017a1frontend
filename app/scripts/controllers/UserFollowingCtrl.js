define(['paw2017a1frontend', 'directives/userListProfile', 'services/UserService', 'services/sharedTypeService', 'services/PaginationService', 'directives/errorList'], function(paw2017a1frontend) {
    ...
    'use strict';
    paw2017a1frontend.controller('UserFollowingCtrl', ['$scope', '$stateParams','$location', 'maxPageHalf', 'perPage','PaginationService' ,'UserService', 'sharedTypeService','baseUrl',
        function($scope, $stateParams, $location, maxPageHalf, perPage, PaginationService, UserService, sharedTypeService, baseUrl) {
