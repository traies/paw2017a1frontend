define(['paw2017a1frontend', 'directives/pagination','directives/gameListProfile', 'services/UserService', 'services/sharedTypeService', 'directives/errorList'], function(paw2017a1frontend) {

    'use strict';
    paw2017a1frontend.controller('UserGamesFollowingCtrl', ['$scope', '$stateParams', '$location', 'maxPageHalf', 'perPage', 'UserService', 'sharedTypeService',function($scope, $stateParams, $location, maxPageHalf, perPage, UserService, sharedTypeService) {
